...
//    private Rule rulePriceNotAdd;//对某种商品价格打折:不可叠加 max会设置成1 一般没有这种情况
    ...
    public void initial() {
        ...
        ruleKindCanAdd = new Rule(0, 0, 2, 0.8, true, null, null, 1, null, discountRange1, null, "kindCanAdd");
        ruleKindNotAdd = new Rule(0, 0, 2, 0.8, false, null, null, 1, null, discountRange1, null, "kindNotAdd");
        ...
        ruleKindCanAdd2 = new Rule(0, 0, 2, 0.5, true, null, null, 1, null, discountRange12, null, "kindCanAdd2");

        //卡布奇诺只有一次半价的机会 第二杯半价不可叠加
        ruleKindNotAdd2 = new Rule(0, 0, 2, 0.5, true, null, null, 1, null, discountRange12, null, "kindNotAdd2");
        ...
        ruleKindCanAdd3 = new Rule(0, 0, 2, 0.5, true, null, null, 1, null, discountRange2, null, "kindCanAdd3");
        ruleKindNotAdd3 = new Rule(0, 0, 2, 0.5, false, null, null, 1, null, discountRange2, null, "kindNotAdd3");

        //对所有商品打折85折
        ruleAllKind = new Rule(0, 0, 2, 0.85, true, null, null, 0, null, null, null, "allKind");
        ...
        rulePriceCanAdd = new Rule(0, 0, 2, 0.8, true, null, null, 1, null, discountRange4, null, "priceCanAdd");
