...
public class ProfitStrategyType1Tests {
    ...
    public void initial() {
        ...
        ruleOneKind = new Rule(0, 0, 1, 1, true, null, null, 1, null, discountRange1, null,102 );//"onekind"
        ...
        ruleMoreKind = new Rule(0, 0, 1, 1, true, null, null, 1, null, discountRange2, null, 103); //twokinds
    }
