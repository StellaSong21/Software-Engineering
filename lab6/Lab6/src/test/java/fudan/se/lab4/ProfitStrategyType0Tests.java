...
public class ProfitStrategyType0Tests {
    ...
    public void initial() {
        ...
        ruleCanAdd = new Rule(0, 0, 0, 30, true, null, null, 0, null, discountRange, null, 100);//"100-30 canAdd"
        ruleNotAdd = new Rule(0, 0, 0, 30, false, null, null, 0, null, discountRange, null, 101);//"100-30 notAdd"
    }
