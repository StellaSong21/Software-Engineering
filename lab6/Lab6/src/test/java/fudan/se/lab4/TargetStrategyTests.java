...
public class TargetStrategyTests {
    ...
    public void initRule() {
        //1.没有优惠条件
        Rule ruleNull = new Rule(0, 0, 0, 0, true, null, null, 0, null, null, null, 1);
        ...
        Rule ruleCorrectTime = new Rule(0, 0, 0, 0, true, from, to, 0, null, null, null, 1);
        ...
        Rule ruleWrongTime = new Rule(0, 0, 0, 0, true, fromWrong, toWrong, 0, null, null, null, 1);
        ...
        Rule ruleTotalPrice = new Rule(0, 0, 0, 0, true, null, null, 0, orderConditionTotalPrice, null, null, 1);
        ...
        Rule rulePartialPrice = new Rule(0, 0, 0, 0, true, null, null, 0, orderConditionPartialPrice, null, null, 1);
        ...
        Rule ruleDrinksNull = new Rule(0, 0, 0, 0, true, null, null, 0, orderConditionDrinksNull, null, null, 1);
        ...
        Rule ruleDrinksNull1 = new Rule(0, 0, 1, 0, true, null, null, 0, orderConditionDrinksNull1, null, null, 1);
        ...
        Rule ruleDrinksOne = new Rule(0, 0, 0, 0, true, null, null, 0, orderConditionDrinksOne, null, null, 1);
...
//        rules.put("drinksOne1", ruleDrinksOne1);
        ...
        Rule ruleDrinksMore = new Rule(0, 0, 0, 0, true, null, null, 0, orderConditionDrinksMore, null, null, 1);
...
//        rules.put("drinksMore1", ruleDrinksMore1);
        ...
        Rule ruleCanAddPrice = new Rule(0, 0, 0, 0, true, null, null, 0, orderConditionCanAddPrice, null, null, 1);
        ...
        Rule ruleNotAddPrice = new Rule(0, 0, 0, 0, false, null, null, 0, orderConditionNotAddPrice, null, null, 1);
        ...
        Rule ruleCanAddDrinks = new Rule(0, 0, 0, 0, true, null, null, 0, orderConditionCanAddDrinks, null, null, 1);
        ...
        Rule ruleNotAddDrinks = new Rule(0, 0, 0, 0, false, null, null, 0, orderConditionNotAddDrinks, null, null, 1);
        ...
        Rule ruleRequireMore = new Rule(0, 0, 0, 0, true, null, null, 0, orderConditionRequireMore, null, null, 1);
        ...
        Rule ruleComposite1 = new Rule(0, 0, 0, 0, true, from, to, 0, orderConditionComposite1, null, null, 1);
        ...
        Rule ruleComposite2 = new Rule(0, 0, 0, 0, true, fromWrong, toWrong, 0, orderConditionComposite2, null, null, 1);
        ...
        Rule ruleInvalidRequireType = new Rule(0, 0, 0, 0, true, null, null, 0, orderConditionInvalidRequireType, null, null, 1);
...
//        assertTrue(isValid("totalPriceEquals", "invalidRequireType", -1));
        isValid("totalPriceEquals", "invalidRequireType", -1);
    }
