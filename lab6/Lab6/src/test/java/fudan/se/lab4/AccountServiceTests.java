...
public class AccountServiceTests {
    ...
    public void testLoginUserNull() {
        boolean flag=accountService.login(null);
        assertFalse(flag);
    }
    ...
    public void testLoginUserNameNull() {
        ...
        boolean flag=accountService.login(user);
        assertFalse(flag);
    }
...
//        assertTrue(flag);
    ...
    public void testSignUpUserNull() {
        boolean flag=accountService.signup(null);
        assertFalse(flag);
    }
    ...
    public void testSignUpUserNameNull() {
        ...
        boolean flag=accountService.signup(user);
        assertFalse(flag);
    }
