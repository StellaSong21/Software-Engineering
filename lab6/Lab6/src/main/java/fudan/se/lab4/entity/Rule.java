...
public class Rule {
    ...
    public Rule(int groupId,int scope,int profitType,double profit, boolean canAdd, Date from, Date to, int isOnlyBasicsDrinks, List<RuleRepositoryImpl.Item> orderCondition, List<RuleRepositoryImpl.Item> discountRange, List<RuleRepositoryImpl.Item> freeDrinks, int id) {
