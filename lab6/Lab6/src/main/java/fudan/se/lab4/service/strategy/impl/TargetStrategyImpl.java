...
//                        logger.info(loggerService.log("PROMOTION_TYPE_NOT_EXISTED"));
                        LoggerServiceImpl.getLoggerService().log(InfoConstant.PROMOTION_TYPE_NOT_EXISTED,InfoConstant.LOGGER_FAIL_STATUS);
                        throw new RuntimeException(InfoConstant.PROMOTION_TYPE_NOT_EXISTED);
//                        return -1;
                }
                if (result == -1)
                    return -1;
