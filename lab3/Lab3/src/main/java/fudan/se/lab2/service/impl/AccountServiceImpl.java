...
public class AccountServiceImpl implements AccountService {
    ...
    public boolean signup(User user) {
        ...
        try {
            ...
            if (checkUserExisted(user.getName())) {
                ...
                throw new RuntimeException(InfoConstant.INVALID_PS);
            }else {
    ...
    public boolean checkPassword(String password) {
        if(password == null){
            logger.info(InfoConstant.INVALID_PS);
            return false;
        }
        if("".equals(password)) {
            logger.info(InfoConstant.INVALID_PS);
        ...
        logger.info(MessageFormat.format(InfoConstant.USERNAME_VALID, password));
        return true;
    }
